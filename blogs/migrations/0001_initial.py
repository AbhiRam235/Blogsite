    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('role', models.CharField(choices=[('reader', 'Reader'), ('writer', 'Writer'), ('both', 'Both')], default='reader', max_length=10)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('content_type', models.CharField(choices=[('text', 'Text'), ('image', 'Image'), ('code', 'Code'), ('youtube', 'YouTube')], max_length=50)),
